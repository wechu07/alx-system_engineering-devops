**This directory contains files on the shell redirections assignment**
...
File 7-file is a script that creates a file containing the text Holberton School ending by a new line.
